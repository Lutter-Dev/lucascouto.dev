...
export type BasicAuthor = { __typename?: 'Author', id: string, name: string, bio?: string | null, photo?: { __typename?: 'Asset', url: string } | null };

export type BasicPost = { __typename?: 'Post', title: string, excerpt: string, createdAt: any, slug: string, featuredImage: { __typename?: 'Asset', url: string }, author?: { __typename?: 'Author', id: string, name: string, bio?: string | null, photo?: { __typename?: 'Asset', url: string } | null } | null };

export type BasicPostDetails = { __typename?: 'Post', title: string, excerpt: string, createdAt: any, slug: string, featuredImage: { __typename?: 'Asset', url: string }, author?: { __typename?: 'Author', id: string, name: string, bio?: string | null, photo?: { __typename?: 'Asset', url: string } | null } | null, content: { __typename?: 'PostContentRichText', json: any }, categories: Array<{ __typename?: 'Category', name: string, slug: string }> };

export type BasicCategory = { __typename?: 'Category', name: string, slug: string };

export type BasicComment = { __typename?: 'Comment', name: string, comment: string, createdAt: any };
...
export type getPostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', title: string, excerpt: string, createdAt: any, slug: string, featuredImage: { __typename?: 'Asset', url: string }, author?: { __typename?: 'Author', id: string, name: string, bio?: string | null, photo?: { __typename?: 'Asset', url: string } | null } | null, content: { __typename?: 'PostContentRichText', json: any }, categories: Array<{ __typename?: 'Category', name: string, slug: string }> }> };
...
export type getSimilarPostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', title: string, excerpt: string, createdAt: any, slug: string, featuredImage: { __typename?: 'Asset', url: string }, author?: { __typename?: 'Author', id: string, name: string, bio?: string | null, photo?: { __typename?: 'Asset', url: string } | null } | null }> };
...
export type getFeaturedPostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', title: string, excerpt: string, createdAt: any, slug: string, featuredImage: { __typename?: 'Asset', url: string }, author?: { __typename?: 'Author', id: string, name: string, bio?: string | null, photo?: { __typename?: 'Asset', url: string } | null } | null }> };
...
export type getPostDetailsQuery = { __typename?: 'Query', post?: { __typename?: 'Post', title: string, excerpt: string, createdAt: any, slug: string, featuredImage: { __typename?: 'Asset', url: string }, author?: { __typename?: 'Author', id: string, name: string, bio?: string | null, photo?: { __typename?: 'Asset', url: string } | null } | null, content: { __typename?: 'PostContentRichText', json: any }, categories: Array<{ __typename?: 'Category', name: string, slug: string }> } | null };
...
export type getCommentsQuery = { __typename?: 'Query', comments: Array<{ __typename?: 'Comment', name: string, comment: string, createdAt: any }> };
...
export type getCategoryPostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', title: string, excerpt: string, createdAt: any, slug: string, featuredImage: { __typename?: 'Asset', url: string }, author?: { __typename?: 'Author', id: string, name: string, bio?: string | null, photo?: { __typename?: 'Asset', url: string } | null } | null }> };
...
export type Post = Node & {
  ...
  featuredImage: Asset;
  featuredPost: Scalars['Boolean']['output'];
...
export type PostContentRichTextEmbeddedTypes = Author | Category | Post;
...
export function getSdk(client: GraphQLClient) {
    const BasicAuthorFragmentDoc = gql`
  ...
  photo {
    url
        ...
        const BasicPostFragmentDoc = gql`
  ...
  author {
    ...BasicAuthor
        ...
        ${BasicAuthorFragmentDoc}
        `

        const BasicPostDetailsFragmentDoc = gql`
  ...
  categories {
    ...
    slug
        ...
        const BasicCategoryFragmentDoc = gql`
  ...
  slug
        ...
        const BasicCommentFragmentDoc = gql`
...
getPosts(
  ...
  posts(locales: [$locale], orderBy: createdAt_DESC) {
    ...BasicPostDetails
                ...
                ${BasicPostDetailsFragmentDoc}
              `,
              variables
            )
          },
      getSimilarPosts(
            variables?: getSimilarPostsQueryVariables
          ): Promise<getSimilarPostsQuery> {
            return client.request<getSimilarPostsQuery>(
              gql`
  ...
  posts(
    ...
    ...BasicPost
      ...
      getFeaturedPosts(
            variables?: getFeaturedPostsQueryVariables
          ): Promise<getFeaturedPostsQuery> {
  ...
  categories(locales: [$locale], orderBy: createdAt_DESC) {
    ...BasicCategory
      ...
      getPostDetails(
            variables?: getPostDetailsQueryVariables
          ): Promise<getPostDetailsQuery> {
            return client.request<getPostDetailsQuery>(
              gql`
  ...
  posts(
    ...
    createComment(
            ...
            return client.request<createCommentMutation>(
              gql`
