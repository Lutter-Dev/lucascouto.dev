import { DropdownMenu, Expanded, FlexBox } from '@ui'
      ...
      <Expanded>
        <FlexBox className="content" justify="center" align="flex-end">
          ...
          <div className={selectedWork == HATCH ? 'visible' : 'hidden'}>
            <p>
              Hatch is a platform that helps people start working together in
              just a few seconds. Using this app you can create a contract,
          ...
          <div className={selectedWork == ACTIVITE ? 'visible' : 'hidden'}>
            <p>
              ...
              assessments of their clients. It was built using Flutter,
